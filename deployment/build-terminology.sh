...
python term-extract.py -s tots-tm -t tots-glossary -c "Glossari construït a partir de les memòries de de traducció de tots els projectes que podeu trobar a http://www.softcatala.org/recursos/memories.html"
