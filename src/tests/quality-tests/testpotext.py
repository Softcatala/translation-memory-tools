...
class TestPOText(unittest.TestCase):
    ...
    def test_write_text_file_spaces(self):
        ...
        entries.append(
            polib.POEntry(
                msgid="Hello\tThis is a test with tab",
        ...
        entries.append(
            polib.POEntry(
                msgid="Hello\tThis is a test with brs",
    ...
    def test_write_text_file_accelerator(self):
        entries = list()
        entries.append(
            polib.POEntry(msgid="This is a test", msgstr="_Això &és una prova~")
        )
    ...
    def test_write_text_file_tags(self):
        entries = list()
        entries.append(
            polib.POEntry(msgid="This is a test", msgstr="Això és una <b>prova<b>")
        )
    ...
    def test_write_text_file_sphinx(self):
        ...
        entries.append(
            polib.POEntry(
                msgid=":kbd:`R` sets the selection to 'replace' in the tool options, "
    ...
    def test_write_text_file_gnome_external_image(self):
        ...
        entries.append(
            polib.POEntry(
                msgid="external ref='figures/brasero-main-window.png' "
    ...
    def test_write_text_file_accutes(self):
        ...
        entries.append(
            polib.POEntry(
                msgid="Add User will set up a new user account ",
